...
<script>
    ...
    acepto = document.getElementsByClassName("aceptaButton");
    rechaza = document.getElementsByClassName("rechazaButton");
    rehacer = document.getElementsByClassName("rehacerButton");
    console.log(acepto,rechaza,rehacer, acepto.length)

    function borrar() {
        for (var i = 0; i <= acepto.length; i++) {
            acepto[i].classList.add("buttonHide");
            rechaza[i].classList.add("buttonHide");
            rehacer[i].classList.remove("buttonHide");
        }
    }

    function borrarRetorno() {
        for (var i = 0; i <= acepto.length; i++) {
            acepto[i].classList.remove("buttonHide");
            rechaza[i].classList.remove("buttonHide");
            rehacer[i].classList.add("buttonHide");
        }
    }
</script>